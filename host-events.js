...
import { iconColorStyle } from "./theme-utils.js?v=20260615b";
import {
  setState,
  getState,
  ...
  currentLocaleState,
  queueAutoPublish,
} from "./host-state.js?v=20260615b";
import {
  collectTemplate,
  syncFields,
  setStatus,
  ...
  syncPanelState,
} from "./host-rendering.js?v=20260615b";
import { dom } from "./host.js?v=20260615b";
...
export function bindAuthEvents(onOpenEditor) {
  ...
  supabase.auth.onAuthStateChange(async (_event, nextSession) => {
    ...
    import("./host-state.js?v=20260615b").then((mod) => {
