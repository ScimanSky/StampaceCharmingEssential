const CACHE_NAME = "stampace-essential-v20260615g";
const STATIC_ASSETS = [
  "./",
  "./index.html",
  "./guest/",
  "./guest/index.html",
  "./styles.css?v=20260615g",
  "./app.js?v=20260615g",
  "./icons.js?v=20260615g",
  "./theme-utils.js?v=20260615g",
  "./content.js?v=20260615g",
  "./supabase.js",
  "./security.js?v=20260615g",
  "./template.json",
  "./manifest.json",
  "./img/app-icon.svg",
