const CACHE_NAME = "stampace-essential-v20260615f";
const STATIC_ASSETS = [
  "./",
  "./index.html",
  "./guest/",
  "./guest/index.html",
  "./styles.css?v=20260615f",
  "./app.js?v=20260615f",
  "./icons.js?v=20260615f",
  "./theme-utils.js?v=20260615f",
  "./content.js?v=20260615f",
  "./supabase.js",
  "./security.js?v=20260615f",
  "./template.json",
  "./manifest.json",
  "./img/app-icon.svg",
