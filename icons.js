export const iconPaths = {
  ...
  airbnb:
    '<circle cx="12" cy="12" r="11.4" fill="#ff5a5f" stroke="none"/><path d="M12 3.55c-2.18 2.66-4.06 5.92-4.06 7.94a2.72 2.72 0 0 0 4.18 2.29 2.72 2.72 0 0 0 3.94-2.5c0-1.95-1.84-5.16-4.06-7.73z" fill="none" stroke="#fff" stroke-width="1.05" stroke-linecap="round" stroke-linejoin="round"/><path d="M10.18 10.16a1.82 1.82 0 1 1 3.64 0c0 1.12-.93 2.48-1.82 3.72-.89-1.24-1.82-2.6-1.82-3.72z" fill="none" stroke="#fff" stroke-width="1.05" stroke-linecap="round" stroke-linejoin="round"/><text x="12" y="19.55" text-anchor="middle" fill="#fff" stroke="none" font-family="Arial, Helvetica, sans-serif" font-size="4.95" font-weight="700" letter-spacing="-.18">airbnb</text>',
  booking:
...
export function renderIcon(name) {
  const isBrand = ["whatsapp", "gmail", "telegram", "airbnb", "booking", "vrbo", "paypal", "revolut"].includes(name);
